...
<header>
    ...
    <div class="heroe">
    <div class="content">
        <h1>NICEPAY -  BI SNAP Virtual Account</h1>
                ...
                <!-- <ul class="navbar-nav mx-auto order-0"> -->
                    ...
                    <!-- <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="Home/createToken">Request Token</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://docs.nicepay.co.id/api-v2-EN.html">Documentation</a>
                    </li>
                </ul>
            </nav> -->
            <form class="group" action="<?php echo site_url();?>CreateVA" method="post">
            <div class="mb-3">
